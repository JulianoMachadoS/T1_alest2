...
Abaixo está o layout da disposição dos pacotes do projeto, com a separação clara entre a implementação em `src/main/java/pennywise` e as validações em `src/test/java/pennywise`:
